...
_QUESTION_TYPE_TOKEN_BUDGETS = {
    ...
    _QUESTION_TYPE_DETAIL: 2560,
    _QUESTION_TYPE_COMPARISON: 4096,
    _QUESTION_TYPE_HYPOTHESIS: 4096,
    _QUESTION_TYPE_EXPLORATORY: 5120,
    _QUESTION_TYPE_SYNTHESIS: 6144,
    _QUESTION_TYPE_DOSSIER: 16384,
}
